# Cosmic Scribe — documentation index

Internal and user-adjacent docs. The main [README](../README.md) is the public landing page.
...
| Doc | Purpose |
|-----|---------|
| [RELEASE.md](RELEASE.md) | OSS readiness checklist |
| [DISTRIBUTION.md](DISTRIBUTION.md) | Homebrew, Cargo install, packaging |
| [GITHUB.md](GITHUB.md) | Remotes, going public |
| [OUTREACH.md](OUTREACH.md) | COSMIC community channels |

## Contributing

[../CONTRIBUTING.md](../CONTRIBUTING.md) — build, tests, architecture, jj workflow.